...
import com.nikitaapp.notes.Adapters.NotesListAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    ActivityResultLauncher<Intent> intentActivityResultLauncher1, intentActivityResultLauncher2, intentActivityResultLauncher;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.song_detail_toolbar_menu_info) {
            ...
            if (!filter) {
                filterPin();
                filter = true;
                item.setIcon(R.drawable.pin_icon);
            } else {
                notesListAdapter.filteredList(notes);
                filter = false;
                item.setIcon(R.drawable.pin_crossed_icon);
            }
        }
